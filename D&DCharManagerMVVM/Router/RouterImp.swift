...
final class RouterImp: NSObject, Router {
    ...
    func present(_ module: Presentable?, animated: Bool) {
        ...
        rootController?.tabBarController?.present(controller, animated: animated, completion: nil)
    }
    
    func present(_ module: Presentable?, animated: Bool, presentType: UIModalPresentationStyle = .overCurrentContext) {
        guard let controller = module?.toPresent() else { return }
        
        controller.modalPresentationStyle = presentType
        rootController?.tabBarController?.present(controller, animated: animated, completion: nil)
    }
